...
%solinit = bvpinit(linspace(0,1,5), [-.5;0]);
%%odes is for evaluating IDEs
%%bcs is for evaluating the residual in the boundary condition
%%solinit [rpvodes a guess for a mesh and the solution on this mesh
...
%Seydel Model for nerve impulses
%y1' = 3(y1+y2-y1^3/3-1.3)
%y2' = -1/3 (y1-0.7+0.8y2)
